...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[var(--radius-card,0px)] border border-border bg-white shadow-[var(--shadow-soft)] transition-all duration-300 ease-out hover:-translate-y-1 hover:border-primary/25 hover:shadow-[var(--shadow-md)]",
      className
    )}
    {...props}
  />
