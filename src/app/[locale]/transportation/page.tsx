...
const busScheduleLabels = {
  ...
  vi: {
    title: "Lịch xe bus",
    subtitle: "Các tuyến xe giường nằm phổ biến từ lịch mới nhất. Giờ chạy và ghế có thể thay đổi, vui lòng xác nhận trước khi đặt vé.",
    route: "Tuyến",
    time: "Giờ",
    type: "Loại xe",
    price: "Giá",
    ...
    timeLabel: "Giờ xe",
    priceLabel: "Từ",
    options: "Lựa chọn có sẵn",
    option: "lựa chọn",
    optionsPlural: "lựa chọn",
    routeCount: "tuyến",
    quickTitle: "Chọn tuyến rồi đặt nhanh qua WhatsApp",
    quickText: "Mở từng tuyến để xem giờ xe, loại xe, điểm đón, điểm trả và giá. Chúng tôi sẽ xác nhận lại ghế trống và giá mới nhất trước khi đặt.",
    groups: {
      "To Phong Nha": "Đến Phong Nha",
      "From Phong Nha": "Từ Phong Nha",
      "North connections": "Tuyến nối miền Bắc",
    },
    note: "Xe có thể đến sớm hoặc trễ do giao thông, tình trạng đường, hoặc các yếu tố khác.",
    cta: "Đặt vé xe",
  },
} as const;
...
const serviceLabels = {
  ...
  vi: {
    route: "Tuyến",
    price: "Từ",
    help: "Chúng tôi sẽ xác nhận lại ghế trống, điểm đón và giá mới nhất trước khi đặt.",
    ready: "Sẵn sàng sắp xếp",
  },
} as const;
