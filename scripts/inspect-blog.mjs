...
const lineIdx = formatted.findIndex(l => l.includes('id="blog"'));
if (lineIdx !== -1) {
  console.log("Found blog section at line:", lineIdx);
  console.log(formatted.slice(lineIdx - 1, lineIdx + 70).join('\n'));
} else {
  console.log("Could not find blog section in stable HTML.");
}
